 ...
 * @author ADMIN
 */
public class DiretorProfessorRemover extends javax.swing.JFrame {

    /**
     * Creates new form DiretorSProfessor
     */
    public DiretorProfessorRemover() {
        initComponents();
...
//                        remover(obterProfessor());
    ...
    private void initComponents() {
        ...
        Imagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rumoif/resources/DiretorProfessorRemover.png"))); // NOI18N
    ...
    private boolean usuarioExiste(Professor a) {
            ...
            String sql = ("SELECT FROM rumoif.login WHERE nome = ? AND email = ? AND usuario = ? AND nivel = 1;");
            try {
            ...
            Logger.getLogger(DiretorProfessorRemover.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
    ...
    private void remover(Professor p) {
        ...
        if (jtNome.getText().isEmpty() || jtEmail.getText().isEmpty() || jtUsuario.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Professor não existestente!");
        }
    ...
    private Professor obterProfessor() {
            ...
            Professor a = new Professor(jtNome.getText(), jtEmail.getText(), jtUsuario.getText());
            return a;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiretorProfessorRemover.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiretorProfessorRemover().setVisible(true);
            }
        });
    }
