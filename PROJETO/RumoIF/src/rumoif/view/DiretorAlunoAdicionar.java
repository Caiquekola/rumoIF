 ...
 * @author ADMIN
 */
public class DiretorAlunoAdicionar extends javax.swing.JFrame {

    /**
     * Creates new form DiretorSProfessor
     */
    public DiretorAlunoAdicionar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        Imagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rumoif/resources/DiretorAlunoAdicionar.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DiretorAlunoAdicionar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DiretorAlunoAdicionar().setVisible(true);
            }
        });
    }
